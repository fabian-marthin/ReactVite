...
import { XMarkIcon, TrashIcon, ChevronDoubleLeftIcon, ChevronDoubleRightIcon } from '@heroicons/react/24/solid';
...
const CheckOutMenu = () => {
    ...
    const borrarItem = (idEliminar) => {
        const nuevosProductos = context.productAddMenuId.filter(producto => producto.id !== idEliminar);
    ...
    const listaCompras = () => {
        const adicionarOrden = {
            ...
            precioTotal: totalPrice(context.productAddMenuId),
            ...
            <div className='contenedorCheck'>
                ...
                <ul>
                    {context.productAddMenuId.map((producto, index) => {
                        ...
                        if (context.cantidades[producto.id] === undefined) {
